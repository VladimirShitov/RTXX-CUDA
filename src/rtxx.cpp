...
void rtxx(Float *A, Float *C, int lda, int ldc,
    ...
    if (depth <= 1 || stop) {
        ...
        GPU_ABt(X6, C11, C21, lda, lda, ldc, XA4, XC4, XC4, YA4, YC4, YC4, 1.0, 0.0);
        // |                  | m9               | m7               | w5               |
        // | ---------------- | m22-z1           | m12              | m3+z5+z8         |
        // | m18              | z3               | w7               | w3               |
        // | ---------------- | m14+z4           | z8               | w6               |
        ...
        GPU_add(C31, C21, C31, lda, lda, ldc, XA4, YA4, 1.0, 1.0);
        ...
        // m15 = w1 @ (w6 + w5).T -> C21
        GPU_ABt(C43, C41, C21, lda, lda, ldc, XA4, XC4, XC4, YA4, YC4, YC4, 1.0, 0.0);
        // |                  | m15              | z7               |                  |
        // | ---------------- | m6+m22-z1        | m12              | m3+z5+z8         |
        // | m18              | z3               | w7               | w1               |
        // | ---------------- | m14+z4           | z8               |                  |
        ...
        GPU_add(C23, C21, C23, lda, lda, ldc, XA4, YA4, 1.0, 1.0);
        // |                  |                  | z7               |                  |
        // | ---------------- | m6+m22-z1        | m12              | m3+z5+z8         |
        // | m18              | z3+m15           | w7               | w1               |
        // | ---------------- | m14+z4           | z8               |                  |
